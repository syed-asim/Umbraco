...
namespace Umbraco.Controllers
{
    public class SurveyController : SurfaceController
    {
        ...
        {
            var res = _surveyBL.AddSurvey(new Data.Survey { SurveyId = Guid.NewGuid(), SurveyName = model.SurveyName, SurveyContent = model.SurveyContent, ModifiedOn = DateTime.Now });
